...
export function PostVehicleWizard({ vehicleId }: { vehicleId?: string } = {}) {
  ...
  const next = () => {
    if (step === 4 && (form.latitude === 0 || form.longitude === 0)) {
        ...
        <div className="rounded-2xl border border-border bg-card p-6">
          ...
          {step === 4 && (
            <div className="space-y-5">
              ...
              <div className="border-t border-border pt-5">
                <p className="mb-3 text-sm font-semibold text-foreground">{t('vehicle_location_map')}</p>
...
{}
          <div className="mt-8 flex items-center justify-between border-t border-border pt-5">
            ...
            {step < steps.length - 1 ? (
              <Button
                onClick={next}
                disabled={step === 4 && (form.latitude === 0 || form.longitude === 0)}
