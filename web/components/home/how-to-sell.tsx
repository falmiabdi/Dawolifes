...
export function HowToSell() {
  ...
  return (
    <section id="how-to-sell" className="mx-auto max-w-7xl px-4 py-14 sm:px-6">
      <div className="text-center">
        <span className="mx-auto inline-flex h-12 w-12 items-center justify-center rounded-xl bg-[#F97316]/10 text-[#F97316]">
          <Tag className="h-6 w-6" />
        </span>
        <h2 className="mt-4 text-2xl font-bold text-foreground">{t("how_to_sell")}</h2>
        <p className="mt-1 text-sm text-muted-foreground">{t("how_to_sell_subtitle")}</p>
      </div>
