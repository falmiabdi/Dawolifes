...
abstract final class AppStrings {
  ...
  AppLanguage.english: {
      ...
      'or': 'OR',
      'verify_email_spam_hint': 'If you don\'t see it, check your inbox — or your spam folder.',
  ...
  AppLanguage.amharic: {
      ...
      'or': 'ወይም',
      'verify_email_spam_hint': 'ካላዩት የኢሜል መልእክት ሳጥንዎን — ወይም የማይፈለግ ኢሜል (spam) አቃፊዎን ያረጋግጡ።',
  ...
  AppLanguage.oromo: {
      ...
      'or': 'YOO',
      'verify_email_spam_hint': 'Yoo hin argin, sanduuqa imeelii kee — yookiin folder spam kee ilaali.',
...
static const Map<AppLanguage, Map<String, String>> _formStrings = {
  AppLanguage.english: {
      ...
      'camera_selfie': 'Camera selfie — full face, no eyeglasses or head cover',
...
All of these rules and agreements are valid and accepted under the laws and regulations of our country.''',
  ...
  AppLanguage.amharic: {
      ...
      'camera_selfie': 'ሴልፊ ከካሜራ — ሙሉ ፊት፣ መነጽር ወይም ራስ መሸፈኛ ሳይኖር',
...
እነዚህ ሁሉ ደንቦች እና ስምምነቶች በሀገራችን ሕግ እና ደንብ በታች የሚቀበሉ እና ተፈጻሚ የሆኑ ናቸው።''',
  ...
  AppLanguage.oromo: {
      ...
      'camera_selfie': 'Suura kaameraa — fuula guutuu, meeta dhaabatuu fi haguuggaa mataa hin qabaatu',
